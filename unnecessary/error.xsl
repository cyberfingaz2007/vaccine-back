...
<body>
	<div id="error_body">
		...
		<cite>
		<h5>Please note</h5>
		The error was logged in the TeconHRM log located in <span class="code"><xsl:value-of select="logPath"/>logDB.txt</span></cite>
		<p>If you are unable to resolve the problem please post the problem in <a href="http://www.Teconhrm.com/forum/">TeconHRM Forum</a></p>
	</div>
</body>
</html>
</xsl:template>
