...
<?php if ($_SESSION['cMethod'] == 'new') { ?>
	...
	if(!document.frmInstall.chkSameUser.checked && frm.dbOHRMUserName.value == '') {
		alert('TeconHRM DB User-name left Empty');
...
<tr>
	<td class="tdComponent">Use the same Database User for TeconHRM</td>
...
<?php  } ?>
<tr>
	<td class="tdComponent">TeconHRM Database Username</td>
...
<tr>
	<td class="tdComponent">TeconHRM Database User Password</td>
...
<div id="oDescription">
<font size="1"># TeconHRM database user should have the rights to insert data into table, update data in a table, delete data in a table.</font>
</div>
