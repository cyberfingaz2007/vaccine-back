...
//// My own Js functions
    ...
    $('a.myMenus').click(function(e){
  		...
  		$('#content').fadeOut().parent().append('<div id="loading" class=" center text-center pull-center"><i class="fa fa-circle-o-notch fa-spin fa-3x stat-elem lg loading-icon"></i><div class="center"></div></div>');
  		$.ajax({
